...
class Gdec():
    ...
    def build(self, X, params):
        with tf.name_scope("gdec"):
            ...
            layer2 = self._dconv_layer(layer1, params["W2_dec"], params["b2_dec"], 2)
            layer3 = self._dconv_layer(layer2, params["W3_dec"], params["b3_dec"], 2)
