...
class D():
    ...
    def build(self, X, params):
        ...
        with tf.name_scope("d"):
            ...
            layer6_d = self._fc_layer(layer5_d, params["W6_fc_d"], params["b6_fc_d"])

            layer5_att = self._fc_layer(layer4, params["W5_fc_att"], params["b5_fc_att"])
            layer6_att = self._fc_layer(layer5_att, params["W6_fc_att"], params["b6_fc_att"])
